...
latex_documents = [
    (master_doc, 'linstor.tex', 'linstor Documentation',
...
man_pages = [
    (master_doc, 'linstor', 'linstor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'linstor', 'linstor Documentation',
     author, 'linstor', 'One line description of project.',
     'Miscellaneous'),
]
